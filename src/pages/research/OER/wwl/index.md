...
関数と再帰呼び出しについても，数学的なことについて簡単に説明します．
...
- 例）2 次関数 $f(x)=x^2-1$ に $x=3$ を代入すると $f(1)=8$ になります．
...
2 日目の講義では，この再帰処理について学びます．
具体的には，再帰処理を使って[フラクタル](https://ja.wikipedia.org/wiki/%E3%83%95%E3%83%A9%E3%82%AF%E3%82%BF%E3%83%AB)を亀さんに描いてもらいます．

以下，簡単に階乗の計算とフィボナッチ数の計算の「再帰」処理について説明します．
...
フィボナッチ数列が生み出すらせんは世界で最も美しいらせんと知られています．
