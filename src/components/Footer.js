            ...
            <div className="columns">
              ...
              <div className="column is-4">
                <section>
                  <ul className="menu-list">
                    <li>
                      <a className="navbar-item" href="https://www.nagoya-u.ac.jp" target="_blank" rel="noopener noreferrer">
                        東海国立大学機構 名古屋大学
                      </a>
                    </li>
                    <li>
                      <a className="navbar-item" href="https://www.ilas.nagoya-u.ac.jp/" target="_blank" rel="noopener noreferrer">
                        名古屋大学 教養教育院
                      </a>
                    </li>
                    <li>
                      <a className="navbar-item" href="https://www.nuee.nagoya-u.ac.jp" target="_blank" rel="noopener noreferrer">
                        名古屋大学大学院 工学研究科 情報・通信工学専攻
                      </a>
                    </li>
                    <li>
                      <a className="navbar-item" href="https://www.katayama.nagoya-u.ac.jp" target="_blank" rel="noopener noreferrer">
                        片山研究室
                      </a>
                    </li>
                    <li>
